...
<nav class="container-fluid" id="nav-flat">
    ...
    <ul style="padding: 10px var(--nav-element-spacing-horizontal);">
        ...
        <li style="padding: 0; margin-left: var(--spacing)">
            <!--on click close menu-->
            <a href="/przypomnienia" class="contrast notification">
...
<aside>
    <nav class="menu" transition:fly|local="{{ x: -200, duration: 400, easing: cubicOut}}">
        <ul>
            ...
            <li style="padding-top: 0; padding-bottom: 0;"><a href="/przypomnienia" class="contrast" style="line-height: var(--line-height);" on:click={() => {menuOpen = false}}>Przypomnienia</a></li>
            {#if loggedIn}
